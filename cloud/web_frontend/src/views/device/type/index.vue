...
<script>
import { listDeviceType, getDeviceType, delDeviceType, addDeviceType, updateDeviceType } from "@/api/device/deviceType"
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id !== undefined) {
            updateDeviceType(this.form).then(() => {
              this.$modal.msgSuccess("修改成功")
              this.open = false
              this.getList()
            })
          } else {
            addDeviceType(this.form).then(() => {
