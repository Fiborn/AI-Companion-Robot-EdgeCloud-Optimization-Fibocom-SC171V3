...
body.iot-theme-dark {
  ...
  .el-tabs__content {
    ...
    border-color: #273a4c !important;
  }

  .components-title,
  .drawing-board .el-form-item__label,
  .empty-info {
  ...
  .drawing-board .drawing-item:hover > .el-form-item,
  .drawing-board .drawing-row-item:hover > .el-form-item {
    color: #d7e5f2 !important;
  ...
  .drawing-row-item:hover > .el-form-item {
    ...
    border-color: rgba(0, 218, 243, .42) !important;
  }
